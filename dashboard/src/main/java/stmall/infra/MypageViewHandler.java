...
public class MypageViewHandler {
    ...
    public void whenOrderPlaced_then_CREATE_1(
        ...
        try {
            ...
            mypage.setCustormerId(orderPlaced.getCustormerId());
    ...
    public void whenDeliveryCompleted_then_UPDATE_1(
        ...
        try {
            ...
            if (mypageOptional.isPresent()) {
                ...
                mypage.setDeliveryStatus(DELEVER);
                // view 레파지 토리에 save
                mypageRepository.save(mypage);
            }
        } catch (Exception e) {
    ...
    public void whenOrderCancled_then_UPDATE_2(
        ...
        try {
            ...
            if (mypageOptional.isPresent()) {
                Mypage mypage = mypageOptional.get();
                // view 객체에 이벤트의 eventDirectValue 를 set 함
                mypage.setOrderStatus(ORDERCANCELD);
                // view 레파지 토리에 save
                mypageRepository.save(mypage);
            }
        } catch (Exception e) {
    ...
    public void whenShippingReturned_then_UPDATE_3(
        ...
        try {
            ...
            if (mypageOptional.isPresent()) {
                Mypage mypage = mypageOptional.get();
                // view 객체에 이벤트의 eventDirectValue 를 set 함
                mypage.setDeliveryStatus(DELEVERYRETURNED);
                // view 레파지 토리에 save
                mypageRepository.save(mypage);
            }
        } catch (Exception e) {
